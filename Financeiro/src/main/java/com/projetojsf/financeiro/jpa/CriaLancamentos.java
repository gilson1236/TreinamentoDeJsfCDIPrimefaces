package com.projetojsf.financeiro.jpa;
...
import com.projetojsf.financeiro.util.JpaUtil;
...
public class CriaLancamentos {
	...
	public static void main(String[] args) {
		...
		lancamento1.setDescricao("Venda de licensa de softwares");
		...
		lancamento1.setValor(new BigDecimal(103_00));
