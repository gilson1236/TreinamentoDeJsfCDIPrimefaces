package com.projetojsf.financeiro.util;
...
public class DiaUtilValidator implements Validator{
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
			...
			if(diaDaSemana < Calendar.MONDAY || diaDaSemana  > Calendar.FRIDAY){
				throw new ValidatorException(new FacesMessage(FacesMessage.SEVERITY_ERROR, "data inválida.", "A data informada não é um dia útil."));
			}
	}
